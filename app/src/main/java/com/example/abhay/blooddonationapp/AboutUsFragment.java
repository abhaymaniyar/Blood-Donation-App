...
public class AboutUsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        details.setText("Hello there! \n" +
                "A little about myself, I am Abhay Maniyar and I am an Computer Science Engineer and like to solve problems using the power of technology.\n" +
                "This app is one of my ways to give back to the society and I hope you will help me with it by keeping this app installed on your phone. \n" +
                "Keeping this app installed will allow you to help even some random guy by a simple search on this app.\n" +
